...
What a great start, this is eighty pages long. It's remarkably friendly- if you're using my notes to skip the papers, maybe just go read this one. 

I think he does a better job than I can, lots of friendly explanation- there was not much simplifying left for me to do, I'm just restating much of what he says.
#### Background
...
Next- we've finally arrived at some math! A crude definition of MDL. We define the "best model" in a simplified setting where we have a list of candidate models (H1, H2, H3) containing hypotheses... imagine each one is "the set of all polynomials of degree N". And we have a bunch of data we're trying to explain, D.
